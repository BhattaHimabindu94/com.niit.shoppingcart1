...
public class CartController 
{
	...
	SessionFactory sf;
	 ...
	 @RequestMapping(value="viewcart",method=RequestMethod.GET)
		public String vcHello(@RequestParam("id") int chairId,HttpSession session)
		{  
	    ...
	    Product chair=bsss.getSingleProduct(chairId);
	    ...
	    // cart.setGrandTotal(chair.getChairPrice());
	   	...
	   	for(int i=0;list.size()>i;i++)
	   	{
	   	  ...
	   	  if(chairId==cti.getProductId())
	   	  {
	   		 
	   		 
	    cartItem.setProductId(chair.getId());
	    cartItem.setProductName(chair.getName());
	    cartItem.setProductPrice(chair.getPrice());
	    cartItem.setProductDesc(chair.getDescription());
	   
	   cartItem.setQuantity(cartItem.getQuantity()+1+cti.getQuantity());
	  
	    cartItem.setProductPrice(chair.getPrice()*cartItem.getQuantity());
	 ...
	 @RequestMapping("/deleteItemCart")
	    public String deleteChair(@RequestParam int id)
	    {
